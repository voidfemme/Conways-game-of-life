...
int main() {
  ...
  while (1) {
    ...
    case KEY_UP:
      ...
      break;
      case KEY_DOWN : highlight_position++;
      if (highlight_position == 4)
        highlight_position = 1;
      break;
      case KEY_STAB : highlight_position++;
      if (highlight_position == 4)
        highlight_position = 2;
      break;
      case 10 : if (highlight_position == 3) {
        endwin();
        return 0;
      }
...
int SetSimSpeed() { return 0; }

void PrintMenu(std::string options[], int number_of_options,
